...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-4 left-4 z-50 inline-flex items-center gap-2 card-soft rounded-full border border-line bg-surface p-3 text-sm font-bold text-foreground transition-transform duration-200 hover:-translate-y-0.5 md:px-4 md:py-3 print:hidden"
    >
